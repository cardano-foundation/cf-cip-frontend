...
export default function Footer() {
  return (
    <footer className="bg-cf-blue-900 border-t border-gray-100/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:flex md:items-center md:justify-between">
