  ...
  const stats = [
    {
      ...
      alt: 'Icon depicting a group of people',
    },
    {
      stat: '184',
      description: 'CIPs',
      ...
      alt: 'Icon depicting a light bulb',
    },
    {
      stat: '12',
      description: 'CPSs',
      ...
      alt: 'Icon depicting a warning sign',
    },
    {
      stat: '30',
      description: 'Open',
      ...
      alt: 'Icon depicting a github pull request',
    },
    {
      stat: '14',
      description: 'Merged',
      ...
      alt: 'Icon depicting a github merge',
    },
  ]
    ...
    <main className="relative isolate min-h-screen bg-cf-blue-900">
      <div className="flex items-center justify-center overflow-hidden bg-transparent pb-12 pt-40">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-6 sm:px-8 lg:px-12">
          ...
          <div className="mt-24 grid w-full grid-cols-1 gap-6 sm:grid-cols-3 md:gap-9 lg:grid-cols-3 lg:gap-4">
            {editors.slice(0, 3).map((person, index) => (
              <PersonCard
                key={index}
                image={person.image}
                name={person.name}
          ...
          {editors.length > 3 && (
            <div className="mt-12 flex w-full justify-center gap-6 sm:gap-9 lg:gap-4">
              {editors.slice(3).map((person, index) => (
                <div className="max-w-[calc(100%/3)] flex-1" key={index + 3}>
                  <PersonCard
                    image={person.image}
                    name={person.name}
                    github_link={person.github_link}
          ...
          <CipList className="mt-24 w-full" />
        </div>
      </div>
